                ...
                <div className="relative overflow-hidden">
                  <Image
                    ...
                    className={`w-full h-auto object-cover transition-transform duration-300 group-hover:scale-105 ${
                      loadedImages.has(getCatImages(category)?.id)
                        ? "opacity-100"
                        : "opacity-0"
                    }`}
                    onLoad={() => handleImageLoad(getCatImages(category)?.id)}
                    // loading="lazy"
                    priority={true}
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>
                      {getCatImages(category)
                        ...
                        .slice(
                          0,
                          getCatImages(category)?.date.toUTCString().length - 13
                        )}
                    </span>
                  </div>
                </div>
