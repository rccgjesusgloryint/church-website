      ...
      <div className="w-full h-full sm:flex gap-2">
        <div className="sm:w-1/3 w-auto">
          <div className="w-auto p-10">
            <h1 className="mb-6 cursor-pointer text-left">
              <Image
        ...
        <div className="sm:w-1/3 w-full">
          <div className="p-10">
            <h1 className="font-bold text-xl pt-5 mb-4 sm:text-left text-center">
              OUR SERVICES
            </h1>
            <div className="leading-10">
              {services.map((service: ServiceType) => (
                <Link
                  href={service.link}
                  target="_blank"
                  className="flex flex-row items-center sm:justify-normal justify-center cursor-pointer"
                  key={service.name}
                >
                  {service.name}
                </Link>
